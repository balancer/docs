...
| [TVL](https://dune.com/balancer/tvl)        | Daily data for TVL, by chain and pool                                                | Date Range in Days, Pool Rank by Daily TVL, Currency |
...
| [Pool Analysis](https://dune.com/balancer/pool-analysis)            | Volume (daily, 24h, 7d, by source), TVL, Swap Fees, LPs, Liquidity Utilization                                    | Pool ID, Start Date, End Date, blockchain |
| [LSTs](https://dune.com/balancer/lst)            | LST pools, Volume (daily, 24h, 7d, by token pair, by LST), Liquidity on LST pools, Liquidity Utilization                                    | Start Date, End Date, blockchain, currency |
| [#ve8020](https://dune.com/balancer/8020-initiative)            | ve8020 Pools, TVL, Impermanent Loss, Price Volatility, Pool Balancer, Volume by Source                                                                                    | Blockchain, Pool Address                     |
